    ...
    return (
        <Box sx={ shopStyles.main }>
            ...
            <form onSubmit={handleSubmit(onSubmit)} >
                <div style={{display:'flex', flexDirection:'column', width:'800px', margin:'50px auto', border:'solid white', padding:'5vh', backgroundColor: 'lightgrey', borderRadius:'5px', height:'72vh', color:'black'}}>
                                ...
                                >
                                    ...
                                    >
                                        <Accordion sx={{ color: 'white', backgroundColor: theme.palette.secondary.light }}>
                                            ...
                                            <AccordionDetails>
                                                <Typography>${parseFloat(shop.price).toFixed(2)}</Typography>
