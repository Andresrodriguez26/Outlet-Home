...
// internal import
import shopImage from '../../assets/images/second.mp4'; 
        ...
        <Root>
            ...
            <Main>
                ...
                <MainText>
                    ...
                    <Button sx={{ marginTop: '10px'}} component={Link} to={myAuth === 'true' ? "/shop" : "/auth"} variant='contained'>Search Properties</Button>
                </MainText>
            </Main>
        </Root>
    )
